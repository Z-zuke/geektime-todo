...
public class TodoItemServiceTest {
    ...
    @Test
    @DisplayName("Add todo item fail")
    ...
    @Test
    @DisplayName("Mark todo item done")
    ...
    @Test
    @DisplayName("Mark todo item fail")
    ...
    @Test
    @DisplayName("List all todo item")
    ...
    @Test
    @DisplayName("List none todo item")
    ...
    @Test
    @DisplayName("List not done todo item")
    ...
    @Test
    @DisplayName("Not list done todo item")
